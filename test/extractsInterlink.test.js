...
test('extracts interlink hashes from tx', async () => {
  ...
  expect(extracted).toEqual([b('aeed62c94315f1e45d4fa9027c9c973d1148f9c0a3dc749c70aa0db0e92cc894')]);
});
...
test('extracts interlink hashes from merkeblock', async () => {
  ...
  expect(extracted).toEqual([b('3ed9f218fcd415e036ccd4b485f252f1dc30db43320d51721b17462a0485a25a'), b('3ed9f218fcd415e036ccd4b485f252f1dc30db43320d51721b17462a0485a25a')]);
});
